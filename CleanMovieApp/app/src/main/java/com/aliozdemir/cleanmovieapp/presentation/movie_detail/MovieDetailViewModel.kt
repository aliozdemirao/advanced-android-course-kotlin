...
import com.aliozdemir.cleanmovieapp.domain.use_case.get_movie_detail.GetMovieDetailsUseCase
...
@HiltViewModel
class MovieDetailViewModel @Inject constructor (private val getMovieDetailsUseCase: GetMovieDetailsUseCase, private val savedStateHandle: SavedStateHandle) : ViewModel() {
